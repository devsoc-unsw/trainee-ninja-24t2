...
export declare function onAudioContextStateChanged(fn: (currState: AudioContextState | "interrupted", prevState: AudioContextState | "interrupted" | undefined) => void): void;
...
export declare function preload(appId: string, channel: string, token: string | null, uid?: UID | null): Promise<void>;
